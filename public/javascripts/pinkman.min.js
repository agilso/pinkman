...
(function() {
  ...
  window.PinkmanCollection = (function(superClass) {
    ...
    PinkmanCollection.prototype.push = function(object) {
      if (typeof object === 'object' && object.isPink && !this.include(object)) {
    ...
    PinkmanCollection.prototype.include = function(object) {
      if ((object != null) && typeof object === 'object') {
        if (object.id != null) {
          ...
          return this.collection.indexOf(object) !== -1;
        }
      } else {
        return false;
      }
    ...
    PinkmanCollection.prototype.firstTwo = function() {
      if ((this.first != null) && typeof this.first === 'function') {
        return this.first(2);
      }
    };

    PinkmanCollection.prototype.firstThree = function() {
      if ((this.first != null) && typeof this.first === 'function') {
        return this.first(3);
      }
    };

    PinkmanCollection.prototype.firstFour = function() {
      if ((this.first != null) && typeof this.first === 'function') {
        return this.first(4);
      }
    };

    PinkmanCollection.prototype.firstFive = function() {
      if ((this.first != null) && typeof this.first === 'function') {
        return this.first(5);
      }
    };

    PinkmanCollection.prototype.firstSix = function() {
      if ((this.first != null) && typeof this.first === 'function') {
        return this.first(6);
      }
    };

    PinkmanCollection.prototype.firstSeven = function() {
      if ((this.first != null) && typeof this.first === 'function') {
        return this.first(7);
      }
    };

    PinkmanCollection.prototype.firstEight = function() {
      if ((this.first != null) && typeof this.first === 'function') {
        return this.first(8);
      }
    };

    PinkmanCollection.prototype.firstNine = function() {
      if ((this.first != null) && typeof this.first === 'function') {
        return this.first(9);
      }
    };

    PinkmanCollection.prototype.firstTen = function() {
      if ((this.first != null) && typeof this.first === 'function') {
    ...
    PinkmanCollection.prototype.getByAttributes = function(object) {
      var k, key, len, match, member, ref, value;
    ...
    PinkmanCollection.prototype.uniq = function(callback) {
      ...
      for (k = 0, len = ref.length; k < len; k++) {
        i = ref[k];
        ref1 = this.collection;
        for (l = 0, len1 = ref1.length; l < len1; l++) {
          j = ref1[l];
          if (((i.pinkey === j.pinkey) || (i.id === j.id)) && (i !== j)) {
            this.remove(i);
          }
        }
      }
    ...
    PinkmanCollection.prototype["new"] = function() {
      var object;
